  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-ink text-base shadow-[0_8px_30px_-8px_rgba(0,0,0,0.4)] print:hidden md:bottom-8 md:right-8 md:h-16 md:w-16"
      >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-24 right-4 z-50 flex h-[min(560px,calc(100vh-7rem))] w-[min(380px,calc(100vw-2rem))] flex-col overflow-hidden rounded-3xl border border-border bg-base shadow-[0_24px_60px_-12px_rgba(0,0,0,0.25)] print:hidden md:bottom-28 md:right-8"
          >
            {/* ヘッダー */}
